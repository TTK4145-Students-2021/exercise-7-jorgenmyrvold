...
def create_backup(backup_path):
    ...
    f = open('/Users/Jorgen/Google_Drive/NTNU/2021_var/sanntidsprogrammering/exercises/exercise-7-jorgenmyrvold/python/terminal_script.txt', 'r')
    script = f.read()
    f.close()
    os.system(script) 
...
if __name__ == "__main__":
    ...
    counter_path = '/Users/Jorgen/Google_Drive/NTNU/2021_var/sanntidsprogrammering/exercises/exercise-7-jorgenmyrvold/python/count.txt'
    backup_path = '/Users/Jorgen/Google_Drive/NTNU/2021_var/sanntidsprogrammering/exercises/exercise-7-jorgenmyrvold/python/backup_alive.txt'
